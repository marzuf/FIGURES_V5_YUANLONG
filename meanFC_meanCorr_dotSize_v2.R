...
# Rscript meanFC_meanCorr_dotSize_v2.R ENCSR489OCU_NCI-H460_40kb TCGAlusc_norm_lusc chr11_TAD390 chr10_TAD268
# Rscript meanFC_meanCorr_dotSize_v2.R ENCSR489OCU_NCI-H460_40kb TCGAluad_norm_luad chr11_TAD390 chr10_TAD268
# Rscript meanFC_meanCorr_dotSize_v2.R ENCSR489OCU_NCI-H460_40kb TCGAluad_mutKRAS_mutEGFR chr10_TAD16 chr17_TAD162
# Rscript meanFC_meanCorr_dotSize_v2.R ENCSR489OCU_NCI-H460_40kb TCGAluad_nonsmoker_smoker chr10_TAD16 chr17_TAD162
# 




script_name <- "meanFC_meanCorr_dotSize_v2.R"
...
outFolder <- "MEANFC_MEANCORR_DOTSIZE_V2"
...
signif_min <- -log10(0.05)
signif_max <- max(ex_DT$adjPvalComb_log10[ex_DT$adjPvalComb_log10 >= -log10(0.05)])
...
pval_005 <- (new_max-new_min) * (-log10(0.05)- signif_min)/(signif_max-signif_min) + new_min
...
legend("bottomleft", 
       legend = c( as.expression(bquote("p-val = " ~ 5^-2)),
                  as.expression(bquote("p-val = " ~ 10^-2))
                                           ),
       pch = 16, 
       pt.cex = c(pval_005, pval_001),
       col = "red",
       bty="n"
       )
